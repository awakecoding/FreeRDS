...
SET(_PROTOBUFC_ROOT_HINTS
	$ENV{PROTOBUFC_ROOTDIR}
	${PROTOBUFC_ROOTDIR})
	
SET(_PROTOBUFC_ROOT_PATHS
	"/opt"
	"/usr"
	"/usr/local"
	"$ENV{PROGRAMFILES}/protobuf"
	"$ENV{PROGRAMFILES}/protobuf-Win32"
	"$ENV{PROGRAMFILES}/protobuf-Win64"
	"C:/protobuf/"
	"C:/protobuf-Win32/"
	"C:/protobuf-Win64/")
	
SET(_PROTOBUFC_ROOT_HINTS_AND_PATHS
	HINTS ${_PROTOBUFC_ROOT_HINTS}
	PATHS ${_PROTOBUFC_ROOT_PATHS})
	
find_library(PROTOBUFC_LIBRARY
							NAMES "protobuf-c"
							${_PROTOBUFC_ROOT_HINTS_AND_PATHS}
							PATH_SUFFIXES "lib")
...
if (PROTOBUFC_FOUND)
	...
	set(PROTOBUFC_INCLUDE_DIRS ${PROTOBUFC_INCLUDE_DIR} "${PROTOBUFC_INCLUDE_DIR}/google")
